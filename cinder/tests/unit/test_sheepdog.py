...
class SheepdogIOWrapperTestCase(test.TestCase):
    ...
    def test_validate(self):
        ...
        self.vdi_wrapper._validate()
        self.assertEqual(True, self.vdi_wrapper._valid)

        self.vdi_wrapper._valid = True

    def test_invalidate(self):
        self.vdi_wrapper._valid = True
        self.vdi_wrapper._invalidate()
        self.assertEqual(False, self.vdi_wrapper._valid)

    def test_is_valid(self):
        self.vdi_wrapper._valid = True
        self.assertTrue(self.vdi_wrapper._is_valid())

        self.vdi_wrapper._valid = False
        self.assertFalse(self.vdi_wrapper._is_valid())
